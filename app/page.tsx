"use client"
import BoulderComponent from "@/components/boulder";
import GameInfoOverlay from "@/components/gameinfo";
import { HandReco } from "@/components/handreco";

import { playBackground, playFX } from "@/utils/audiohandler";

import { useEffect, useRef, useState } from "react";
import { RockeCompo } from "@/components/rocket";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className={`absolute left-3 top-3 z-30 transition-all duration-500 ${isDetected ? 'w-24' : 'w-48'} `}>
        <HandReco sethandresults={setHandResults} />
      </div>
